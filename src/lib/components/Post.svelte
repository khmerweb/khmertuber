<script>    
    ...
    const url = `https://khmervideo.vercel.app/post/${post.id}`
    ...
    $effect(() => { 
        var disqus_config = function () {
            this.page.url = `https://khmervideo.vercel.app/post/${post.id}`;  // Replace PAGE_URL with your page's canonical URL variable
